...
public static class PerlinNoise
{
	...
	public static void SetSeed(float seed) => Seed = seed;

	public static float GetSeed() => Seed;

	public static float Sample(float x) => Noise(x * Seed, 0, 0);

	public static float Sample(float x, float y) => Noise(x * Seed, y * Seed, 0);

	public static float Sample(float x, float y, float z) => Noise(x * Seed, y * Seed, z * Seed);
